...
def home(request):
    return render(request, 'passgen_app/home.html',{'dict_key':'value'})

def password_generator_page(request):
    return render(request, 'passgen_app/password_generator_page.html')
...
def generated_password_page(request):
    ...
    return render(request, 'passgen_app/generated_password_page.html', {'generated_password':generated_password})

#, {'generated_password_value':password_length}


def about_page(request):
    return render(request, 'passgen_app/about_page.html')
